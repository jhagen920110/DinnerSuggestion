...
def make_icon(source_path, size):
    ...
    # Trim chopstick overhang on left: crop ~8% off left side
    trim_left = int(white_layer.width * 0.08)
    white_layer = white_layer.crop((trim_left, 0, white_layer.width, white_layer.height))
